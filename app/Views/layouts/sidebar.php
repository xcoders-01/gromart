...
<div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
            <img src="<?= base_url('assets/AdminLTE') ?>/f_dist/img/user7-128x128.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
            ...
            <?php if (isset($s_store)): ?>
                ...
                <li class="nav-item  <?= $menu == 'master_data' ? 'menu-open' : '' ?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('unit') ?>" class="nav-link <?= $submenu == 'unit' ? 'active' : '' ?>">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Satuan</p>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a href="<?= base_url('report') ?>" class="nav-link <?= $menu == 'report' ? 'active' : '' ?>">
